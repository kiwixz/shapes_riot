...
TEST_SUITE("span")
{
    ...
    TEST_CASE("constexpr")
    {
        ...
        constexpr Span<const char> midspan2 = midspan;
        constexpr Span<const char> midspan3 = std::move(midspan2);
        constexpr Span<const char> span{midspan3.data(), midspan3.size()};
